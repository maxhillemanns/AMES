...
selected_img = [image_loc+"adult/MAX_adult_1_1.tif", \
                image_loc+"adult/MAX_adult_204_1.tif", \
                image_loc+"adult/MAX_adult_207_2.tif", \
                image_loc+"cor4u/MAX_cor4u_4_3.tif", \
                image_loc+"cor4u/MAX_cor4u_6_3.tif", \
                image_loc+"cor4u/MAX_cor4u_42_1.tif", \
                image_loc+"neonatal/MAX_neonatal_16_1.tif", \
                image_loc+"neonatal/MAX_neonatal_54_2.tif", \
                ]
...
#    plt.savefig(save_loc+'igrad_exp_heatmap_'+selected_img[i].split('/')[-1][4:-4]+'.png')
    ...
    plt.savefig(save_loc+'grad_exp_heatmap_'+selected_img[i].split('/')[-1][4:-4]+'.png')
